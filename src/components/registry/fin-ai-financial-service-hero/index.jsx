...
// (src/components/registry/fin-ai-financial-service-hero) — TS types stripped
// to match this project's plain-JSX convention.
...
function ChatInterface({ botName = "Fin" }) {
  return (
...
export default function FinAiFinancialServiceHero({
  ...
  return (
    <section id="home" className="relative min-h-screen w-full overflow-hidden" style={{ backgroundColor: COLORS.background }}>
      {/* Background Pattern */}
      <DashboardBackground />
