...
// (src/components/registry/oyster-embedded-hero) — TS types stripped to
// match this project's plain-JSX convention. Headline swapped from the
// original italic serif to a bold sans-serif treatment.
...
function ArrowDecoration({ direction, className, color }) {
...
export default function OysterEmbeddedHero({
  ...
  return (
    <section id="home" className="relative min-h-screen w-full bg-white overflow-hidden flex flex-col items-center justify-center py-20">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        {/* Headline */}
        <motion.h1
          className="font-sans font-bold text-4xl md:text-5xl lg:text-6xl leading-tight mb-8"
        ...
        >
          ...
          >
            {headlineLine1Highlight}
          </span>
          <span className="text-neutral-900">{" "}{headlineLine1End}</span>
          <br />
          <span style={{ color: colors.accent }}>{headlineLine2}</span>
        </motion.h1>
